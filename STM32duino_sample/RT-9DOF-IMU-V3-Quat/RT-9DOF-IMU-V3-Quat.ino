/****************************************************************
 * RT-9DOF-IMU-V3-Quat.ino
 * This file is forked from SparkFun_ICM-20948_ArduinoLibrary examples
...
void timerInterrupt(void)
{
  ...
  if ((myICM.status == ICM_20948_Stat_Ok) || (myICM.status == ICM_20948_Stat_FIFOMoreDataAvail)) // Was valid data available?
  {
    if ((data.header & DMP_header_bitmap_Quat6) > 0) // && (data.header & DMP_header_bitmap_Gyro) > 0)
    {
      ...
      raw_data[22] = (data.Quat6.Data.Q1 >> 16) & 0xFF;
      raw_data[23] = (data.Quat6.Data.Q1 >> 24) & 0xFF;
      raw_data[24] = (data.Quat6.Data.Q2 >> 0) & 0xFF;
      raw_data[25] = (data.Quat6.Data.Q2 >> 8) & 0xFF;
      raw_data[26] = (data.Quat6.Data.Q2 >> 16) & 0xFF;
      raw_data[27] = (data.Quat6.Data.Q2 >> 24) & 0xFF;
      raw_data[28] = (data.Quat6.Data.Q3 >> 0) & 0xFF;
      raw_data[29] = (data.Quat6.Data.Q3 >> 8) & 0xFF;
      raw_data[30] = (data.Quat6.Data.Q3 >> 16) & 0xFF;
      raw_data[31] = (data.Quat6.Data.Q3 >> 24) & 0xFF;

      raw_data[32] = cal_checksum(raw_data, 32);

      SERIAL_PORT.write(raw_data, 33);
      ...
      // double gx = ((double)data.Raw_Gyro.Data.X) / 16.3835 * PI / 180.0; // [rad/s] 16.3835=32767/2000   deg2rad
      ...
      // SERIAL_PORT.print(F(","));
      // SERIAL_PORT.print(q2, 4);
      // SERIAL_PORT.print(F(","));
      // SERIAL_PORT.print(q3, 4);
      // SERIAL_PORT.print(F(","));
      // SERIAL_PORT.print(q0, 4);
      // SERIAL_PORT.print(F(","));
      // SERIAL_PORT.print(gx, 4);
      // SERIAL_PORT.print(F(","));
      // SERIAL_PORT.print(gy, 4);
      // SERIAL_PORT.print(F(","));
      // SERIAL_PORT.print(gz, 4);
